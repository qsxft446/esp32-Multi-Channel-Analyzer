...
- **Мёртвое время.** Программы считают его как
  ...
  программы тогда совпадает с прибором.
- **Число каналов в BecqMoni — 8192.** Прибор, как и настоящий, всегда
  отдаёт 8192 канала; если в настройках BecqMoni меньше, она складывает
  соседние каналы (при 2048 — по 4), и пики «сжимаются». При 8192 номера
  каналов совпадают с прибором.
