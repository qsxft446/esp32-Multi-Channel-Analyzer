...
- **Спектр** — набор, лин/лог шкала, анализ выделенного пика (центр,
  ...
  таблица параметров обработки, что на «Конфиг MCA»: их можно менять прямо
...
- `test_dsp.py` — 9 уровней проверок обработки на модели, в том числе
  векторная версия против обычной и сжатие кадров осциллографа против
  расшифровщика страницы (в node). `python tools/test_dsp.py`.
